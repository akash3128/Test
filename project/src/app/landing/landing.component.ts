...
export class LandingComponent {
  ...
  FormDetails() {
    this.form = this.fb.group({
      ...
      MobileNo: [this.dataById ? this.dataById.MobileNo : '', Validators.required, Validators.minLength(10), Validators.maxLength(10), Validators.pattern("^((\\+91-?)|0)?[0-9]{10}$")],
      Email: [this.dataById ? this.dataById.Email : '', Validators.required, Validators.pattern("^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$")],
